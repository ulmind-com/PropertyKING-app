...
const styles = StyleSheet.create({
  ...
  avatarPlaceholderText: { fontSize: 44, fontFamily: 'Raleway_800ExtraBold', color: COLORS.primary },
  ...
  changePhotoText: { fontSize: 14, fontFamily: 'Raleway_700Bold', color: COLORS.primary },
  ...
  inputLabel: { fontSize: 11, fontFamily: 'Raleway_700Bold', color: COLORS.textMuted, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 2 },
  inputRaw: { fontSize: 16, fontFamily: 'Raleway_600SemiBold', color: COLORS.text, padding: 0, margin: 0 },
  ...
  callingCodeText: { fontSize: 14, fontFamily: 'Raleway_700Bold', color: COLORS.text },
  ...
  saveBtnText: { color: '#FFF', fontSize: 16, fontFamily: 'Raleway_800ExtraBold', letterSpacing: 0.5 },
  ...
  modalTitle: { fontSize: 18, fontFamily: 'Raleway_800ExtraBold', color: COLORS.text },
  ...
  countryOptionName: { flex: 1, fontSize: 16, fontFamily: 'Raleway_600SemiBold', color: COLORS.text },
  countryOptionCode: { fontSize: 16, fontFamily: 'Raleway_700Bold', color: COLORS.textSecondary },
});
